...
class Station:
    ...
    def __init__(self, *args: Any) -> None:
        self.__number: Optional[int] = args[0] if len(args) > 0 else None
        self.__station_code: Optional[str] = args[1] if len(args) > 1 else None
        ...
        self.__voivodship: Optional[str] = args[10] if len(args) > 10 else None
        self.__city: Optional[str] = args[11] if len(args) > 11 else None
        self.__address: Optional[str] = args[12] if len(args) > 12 else None
